...
import com.project.resource.vm.LoginVM;
...
public class StudentJwtController {
    ...
    public StudentJwtController(JwtTokenProvider jwtTokenProvider, AuthenticationManagerBuilder authenticationManagerBuilder) {
